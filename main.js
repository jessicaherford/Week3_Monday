...
// 4. Define a function called "quarter". It accepts one parameter called "number".
...
// 5. Define functions called "area" and "perimeter". They should both accept two parameters and calculate the area and perimeter of a rectangle.

// 6. Write a function called "sleepings", it should accept one parameter, an integer called "hours".
...
// 7. Prompt a user to enter a six digit number. Write a function that reverses the number.
//    (Hint, you will have to turn the integer into a string before you can reverse it.)

// 8. Within the fuction you wrote in #7, write a conditional statement that checks to ensure the user entered a six digit integer.
